...
def server_app_initial(identifier: int) -> Application:
    return Application(
        display_name=f"Opensourcerer Chat Server App {identifier}",
...
def client_app(server_app_id: str, server_app: Application, identifier: int) -> Application:
    return Application(
        display_name=f"Opensourcerer Chat Client App {identifier}",
        sign_in_audience="AzureADMyOrg",
        web=WebApplication(
